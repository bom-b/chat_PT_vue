...
export default defineComponent({
  ...
  computed: {
    ...
    itemsToShow() {
      return this.windowWidth <= 768 ? 1.5 : 3.95;
    },
  },
  mounted() {
...
<template>
  <main class="main">
    ...
    <div class="container main">
      <div class="title-box">
        <h2 class="TheJamsil400">선호하는 음식 선택 <span class="mandatory">(5개 선택 필수)</span></h2>
        <p class="mt-3">음식 추천을 할 때 도와드려요</p>
      </div>
      <Carousel :autoplay="4000" :itemsToShow="itemsToShow" :wrapAround="true" :transition="500">
        <Slide v-for="slide in foodList" :key="slide">
          <div class="carousel__item">
            <div class="card" style="width:100%;" @click="selectFood(slide)">
              ...
              <div class="container foodimg-text" style="display: flex; justify-content: center; align-items: center;">
                <h4><b>{{ slide.FOODNAME }}</b></h4><img style="width: 20px; height: 20px;"
                                                         src="../../../assets/img/icon/icon-check-mark.png"
                                                         v-if="rating.includes(slide.FOODNUM)">
    ...
    <div class="center-container">
      <div v-for="food in foodName" :key= "food" style="display: flex;">
        <span style="font-size: 1.3rem;" >{{ food }}</span>
      </div>
...
@media (max-width: 768px) {
  ...
  .mandatory {
    display: block; /* 블록 레벨 요소로 만들어 줄바꿈을 유도 */
  }
