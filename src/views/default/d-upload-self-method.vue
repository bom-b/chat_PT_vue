  ...
  <main id="main" class="main">
    ...
    <div class="container" style="text-align: center; " v-else>
      ...
      <div class="d-flex justify-content-center">
        <ul class="pagination pagination-lg">
          <li class="page-item" v-for="tab in ['아침', '점심', '저녁', '간식']" :key="tab">
            <a class="page-link" :class="{ 'selected-tab': selectedTab === tab }" href="#"
      ...
      <div v-if="selectedTab === '아침'">
        <imgUpload :max-images="5" :uploaded-images="tabImages.아침" @image-removed="removeImage('아침', $event)"
          @image-uploaded="updateImages('아침', $event)" />
      </div>
      <div v-if="selectedTab === '점심'">
        <imgUpload :max-images="5" :uploaded-images="tabImages.점심" @image-removed="removeImage('점심', $event)"
          @image-uploaded="updateImages('점심', $event)" />
      </div>
      <div v-if="selectedTab === '저녁'">
        <imgUpload :max-images="5" :uploaded-images="tabImages.저녁" @image-removed="removeImage('저녁', $event)"
          @image-uploaded="updateImages('저녁', $event)" />
      </div>
      <div v-if="selectedTab === '간식'">
        <imgUpload :max-images="5" :uploaded-images="tabImages.간식" @image-removed="removeImage('간식', $event)"
